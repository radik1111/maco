...
function footer_menu() {
    register_nav_menu('header',__( 'Шапка' ));
    register_nav_menu('footer',__( 'Футер' ));
    register_nav_menu('uslugi',__( 'Услуги' ));
    register_nav_menu('company',__( 'Компания' ));
}
